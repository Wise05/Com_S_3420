...
public interface AST {
    interface Visitor<T> {
        ...
        T visit(AST.SwitchExp e, Env env);

        T visit(AST.CaseExp e, Env env);

        T visit(AST.DefaultExp e, Env env);
        // ===================================================
    ...
    // Switch Statement added here!! ==============
    class SwitchExp extends Exp {
      Exp _val;
      ArrayList<CaseExp> _cases;
      Exp _default;

      public SwitchExp(Exp val, ArrayList<CaseExp> cases, Exp default_exp) {
        _val = val;
        _cases = cases;
        _default = default_exp;
      }
      ...
      public ArrayList<CaseExp> cases() {
        return _cases;
      }

      public Exp default_exp() {
        return _default;
      }
    ...
    class CaseExp extends Exp {
      Exp _match_exp;
      Exp _exp;

      public CaseExp(Exp match_exp, Exp exp) {
        _match_exp = match_exp;
        _exp = exp;
      }

      public Exp match_exp() {
        return _match_exp;
      }
    ...
    class DefaultExp extends Exp {
      Exp _exp;

      public DefaultExp(Exp exp) {
        _exp = exp;
      }
