...
public class TypeLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "Num", "Bool", "ListT", "RefT", "UnitT", "Ref", "Deref", "Assign", 
			"Free", "Lambda", "If", "Car", "Cdr", "Cons", "List", "Null", "Less", 
			"Equal", "Greater", "TrueLiteral", "FalseLiteral", "Define", "Let", "Dot", 
